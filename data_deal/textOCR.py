...
def node_name_filter(node_name):
    ...
    # filter_lists = ['复制(C)','复制(c)','企业名称信用编码法定代表人股东失信被执行人 请输入企业名称 选择地区搜索']
...
if __name__ == '__main__':
    ...
    text_in = 'F:\\cwd\\mind_test\\django_test2\\vue\public\\result1.txt'
    text_out = 'F:\\cwd\\mind_test\\django_test2\\vue\public\\result2.txt'
    password = '123456'
